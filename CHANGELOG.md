Versão 6.0.0 (10/08/2026)
* Recurso adicionado: Campos brasileiros nativos e gratuitos (CPF, CNPJ, tipo de pessoa, RG, Inscrição Estadual, data de nascimento, gênero, celular, número e bairro), dispensando o plugin Brazilian Market on WooCommerce
  - Novas configurações com paridade ao Brazilian Market: modo de tipo de pessoa, exibição de RG/IE/nascimento/gênero, campo de celular, bairro obrigatório e validação de CPF/CNPJ
