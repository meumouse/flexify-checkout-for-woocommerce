...
class Integrations_Data {
    ...
    private static function get_third_party_cards() {
        // The recovery-carts id is kept here even though the card was removed: the
        // legacy Integrations view still registers it on the filter, and without
        // the exclusion it would come back rendered as a third-party HTML card.
