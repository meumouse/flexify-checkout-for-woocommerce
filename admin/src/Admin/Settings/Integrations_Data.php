    ...
    public static function get_cards_for_client() {
        ...
        $cards = array(
            array(
                ...
                'priority' => 1,
                'pro' => true,
                'title' => __( 'Data tracking', 'flexify-checkout-for-woocommerce' ),
                'description' => __( 'Set up GA4, Google Ads, and Meta to send event data collected at checkout.', 'flexify-checkout-for-woocommerce' ),
            ),
            self::module_card( array(
                'id' => 'inter-bank',
                'priority' => 10,
                'pro' => true,
                'title' => __( 'Flexify Checkout - Inter add-on', 'flexify-checkout-for-woocommerce' ),
                'description' => __( 'Start receiving via Pix and Boleto with immediate approval and no fees. Exclusive for Inter Empresas customers.', 'flexify-checkout-for-woocommerce' ),
            ...
            self::module_card( array(
                ...
                'priority' => 20,
                'pro' => true,
                'title' => __( 'Flexify Checkout - Abandoned cart recovery', 'flexify-checkout-for-woocommerce' ),
                'description' => __( 'Recover abandoned carts and orders with scheduled follow-ups. Send WhatsApp notifications automatically and much more!', 'flexify-checkout-for-woocommerce' ),
            ...
            self::module_card( array(
                ...
                'description' => __( 'Automate sending WhatsApp messages when Flexify Checkout events occur, and recover sales more effectively. Keep everything flowing with no effort!', 'flexify-checkout-for-woocommerce' ),
            ...
            array(
                ...
                'description' => __( 'Make it easier for users to fill in the delivery address by allowing address search or using geolocation features with Google Maps.', 'flexify-checkout-for-woocommerce' ),
            ),
            self::module_card( array(
                'id' => 'payco',
                'priority' => 50,
                ...
                'description' => __( 'Receive payments with Pix, Credit Card, Open Finance, and Bank Slip.', 'flexify-checkout-for-woocommerce' ),
