...
class Assets {
    ...
    public function admin_scripts() {
        ...
        if ( Helpers::check_admin_page('fc-recovery-carts') && ! Helpers::check_admin_page('fc-recovery-carts-list') && ! Helpers::check_admin_page('fc-recovery-carts-queue') ) {
			...
			wp_localize_script( 'fc-recovery-carts-scripts', 'fcrc_settings_params', array(
				...
				'i18n' => array(
					'toast_aria_label' => esc_html__( 'Fechar', 'flexify-checkout-for-woocommerce' ),
                    'confirm_delete_follow_up' => esc_html__( 'Tem certeza que deseja excluir este evento?', 'flexify-checkout-for-woocommerce' ),
                    'emoji_picker' => array(
						'placeholder' => esc_html__( 'Pesquisar', 'flexify-checkout-for-woocommerce' ),
						'button_title' => esc_html__( 'Use a tecla TAB para inserir um emoji rapidamente', 'flexify-checkout-for-woocommerce' ),
						'filters' => array(
							'tones_title' => esc_html__( 'Diversidade', 'flexify-checkout-for-woocommerce' ),
							'recent_title' => esc_html__( 'Recentes', 'flexify-checkout-for-woocommerce' ),
							'smileys_people_title' => esc_html__( 'Sorrisos e Pessoas', 'flexify-checkout-for-woocommerce' ),
							'animals_nature_title' => esc_html__( 'Animais e Natureza', 'flexify-checkout-for-woocommerce' ),
							'food_drink_title' => esc_html__( 'Comidas e Bebidas', 'flexify-checkout-for-woocommerce' ),
							'activity_title' => esc_html__( 'Atividades', 'flexify-checkout-for-woocommerce' ),
							'travel_places_title' => esc_html__( 'Viajens e Lugares', 'flexify-checkout-for-woocommerce' ),
							'objects_title' => esc_html__( 'Objetos', 'flexify-checkout-for-woocommerce' ),
							'symbols_title' => esc_html__( 'Símbolos', 'flexify-checkout-for-woocommerce' ),
							'flags_title' => esc_html__( 'Bandeiras', 'flexify-checkout-for-woocommerce' ),
						),
					),
				),
        ...
        if ( Helpers::check_admin_page('fc-recovery-carts') && ! Helpers::check_admin_page('fc-recovery-carts-list') && ! Helpers::check_admin_page('fc-recovery-carts-queue') && ! Helpers::check_admin_page('fc-recovery-carts-settings') ) {
			...
			wp_localize_script( 'fc-recovery-carts-analytics-scripts', 'fcrc_analytics_params', array(
				...
				'i18n' => array(
					'toast_aria_label' => esc_html__( 'Fechar', 'flexify-checkout-for-woocommerce' ),
                    'total_recovered' => __( 'Valor recuperado', 'flexify-checkout-for-woocommerce' ),
                    'notifications_chart' => __( 'Notificações', 'flexify-checkout-for-woocommerce' ),
				),
                'currency' => array(
    ...
    public function frontend_scripts() {
        ...
        wp_localize_script( 'fc-recovery-carts-events-script', 'fcrc_events_params', array(
            ...
            'i18n' => array(
                'intl_search_input_placeholder' => esc_html__( 'Pesquisar', 'flexify-checkout-for-woocommerce' ),
            ),
            'enable_international_phone' => Admin::get_switch('enable_international_phone_modal'),
