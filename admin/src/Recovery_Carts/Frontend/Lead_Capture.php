        ...
        <div class="fcrc-popup-container lead-capture-modal">
            <div class="fcrc-popup-content">
                <div class="fcrc-popup-header">
                    <button class="fcrc-popup-close" aria-label="<?php esc_attr_e( 'Close', 'flexify-checkout-for-woocommerce' ); ?>"></button>
                </div>
                    ...
                    <div class="fcrc-pre-checkout-form">
                        ...
                        <div class="fcrc-contact-name-wrapper mb-4">
                            <div class="fcrc-first-name-wrapper">
                                <label class="form-label"><?php esc_html_e( 'Name: *', 'flexify-checkout-for-woocommerce' ); ?></label>
                                <input type="text" class="fcrc-input fcrc-get-first-name" required placeholder="<?php esc_attr_e( 'John', 'flexify-checkout-for-woocommerce' ); ?>" value="<?php echo $first_name ?? ''; ?>">
                            </div>

                            <div class="fcrc-last-name-wrapper">
                                <label class="form-label"><?php esc_html_e( 'Last name: *', 'flexify-checkout-for-woocommerce' ); ?></label>
                                <input type="text" class="fcrc-input fcrc-get-last-name" required placeholder="<?php esc_attr_e( 'Doe', 'flexify-checkout-for-woocommerce' ); ?>" value="<?php echo $last_name ?? ''; ?>">
                            </div>
                        </div>

                        <div class="fcrc-contact-phone-wrapper mb-4">
                            <div class="me-3 w-100">
                                <label class="form-label"><?php esc_html_e( 'Phone / WhatsApp: *', 'flexify-checkout-for-woocommerce' ); ?></label>
                                <input type="tel" class="fcrc-input fcrc-get-phone" required placeholder="<?php esc_attr_e( '+1 555 123-4567', 'flexify-checkout-for-woocommerce' ); ?>" value="<?php echo $phone ?? ''; ?>">
                            </div>
                        </div>

                        <div class="fcrc-contact-email-wrapper mb-4">
                            <div class="me-3 w-100">
                                <label class="form-label"><?php esc_html_e( 'Your best email: *', 'flexify-checkout-for-woocommerce' ); ?></label>
                                <input type="email" class="fcrc-input fcrc-get-email" required placeholder="<?php esc_attr_e( 'johndoe@email.com', 'flexify-checkout-for-woocommerce' ); ?>" value="<?php echo $email ?? ''; ?>">
                            </div>
                        </div>
