    ...
    public static function integration_tab_items() {
        return apply_filters( 'Flexify_Checkout/Recovery_Carts/Settings/Tabs/Integrations', array(
            'joinotify' => array(
                ...
                'description' => __('Use o melhor e mais completo construtor de automações com WhatsApp para notificar seus usuários.', 'flexify-checkout-for-woocommerce'),
            ...
            'email' => array(
                'title' => __('E-mail', 'flexify-checkout-for-woocommerce'),
                'description' => __('Notifique seus usuários e clientes com e-mails personalizados da sua marca.', 'flexify-checkout-for-woocommerce'),
