    ...
    public static function integration_tab_items() {
        return apply_filters( 'Flexify_Checkout/Recovery_Carts/Settings/Tabs/Integrations', array(
            'joinotify' => array(
                ...
                'description' => __('Use the best and most complete WhatsApp automation builder to notify your users.', 'flexify-checkout-for-woocommerce'),
            ...
            'email' => array(
                'title' => __('Email', 'flexify-checkout-for-woocommerce'),
                'description' => __('Notify your users and customers with custom emails from your brand.', 'flexify-checkout-for-woocommerce'),
