...
<div id="follow_up" class="nav-content">
    <div class="ps-5">
        <div class="mb-3">
            <span class="fw-semibold"><?php esc_html_e( 'Personalizar lista de mensagens de acompanhamento (Follow up)', 'flexify-checkout-for-woocommerce' ); ?></span>
            <span class="fc-recovery-carts-description"><?php esc_html_e( 'As notificações de follow up irão ser disparadas em um tempo pré-definido para lembrar o usuário de finalizar seu pedido.', 'flexify-checkout-for-woocommerce' ); ?></span>
        </div>

        <?php echo Admin_Components::follow_up_list(); ?>

        <button id="fcrc_add_new_follow_up_trigger" class="btn btn-primary mt-3"><?php esc_html_e( 'Adicionar novo evento', 'flexify-checkout-for-woocommerce' ); ?></button>
        ...
        <div id="fcrc_add_new_follow_up_container" class="fcrc-popup-container">
            <div class="fcrc-popup-content">
                <div class="fcrc-popup-header">
                    <h5 class="fcrc-popup-title"><?php esc_html_e( 'Adicionar novo follow up', 'flexify-checkout-for-woocommerce' ); ?></h5>
                    <button id="fcrc_add_new_follow_up_close" class="btn-close fs-5" aria-label="<?php esc_attr_e( 'Fechar', 'flexify-checkout-for-woocommerce' ); ?>"></button>
                </div>
                ...
                <div class="fcrc-popup-body">
                    <div class="mb-5">
                        ...
                        <input id="fcrc_add_new_follow_up_title" type="text" class="form-control" placeholder="<?php esc_attr_e( 'Nome do evento', 'flexify-checkout-for-woocommerce' ); ?>">
                    </div>

                    <div class="mb-5">
                        <label class="form-label text-left"><?php esc_html_e( 'Mensagem: *', 'flexify-checkout-for-woocommerce' ); ?></label>
                        <textarea id="fcrc_add_new_follow_up_message" class="form-control add-emoji-picker" placeholder="<?php esc_attr_e( 'Mensagem que será enviada', 'flexify-checkout-for-woocommerce' ); ?>"></textarea>
                    </div>
                    ...
                    <div class="mb-5">
                        ...
                        <div class="input-group get-delay-info">
                            ...
                            <select id="fcrc_add_new_follow_up_delay_type" class="form-select">
                                <option value="minutes"><?php esc_html_e( 'Minutos', 'flexify-checkout-for-woocommerce' ); ?></option>
                                <option value="hours"><?php esc_html_e( 'Horas', 'flexify-checkout-for-woocommerce' ); ?></option>
                                <option value="days"><?php esc_html_e( 'Dias', 'flexify-checkout-for-woocommerce' ); ?></option>
                            </select>
                        </div>
                    </div>
                </div>
                ...
                <div class="fcrc-popup-footer">
                    <button id="fcrc_add_new_follow_up_save" class="btn btn-primary"><?php esc_html_e( 'Adicionar', 'flexify-checkout-for-woocommerce' ); ?></button>
                </div> 
            </div>
        </div>
    </div>
