...
<div id="styles" class="nav-content">
    <table class="form-table">
        <tbody>
            <tr>
                <th>
                    <?php esc_html_e( 'Cor primária', 'fc-recovery-carts' ); ?>
                ...
                <td>
                    <div class="color-container input-group">
                        ...
                        <button class="btn btn-outline-secondary btn-icon reset-color fcrc-tooltip" data-color="#008aff" data-text="<?php esc_html_e( 'Redefinir para cor padrão', 'fc-recovery-carts' ) ?>">
