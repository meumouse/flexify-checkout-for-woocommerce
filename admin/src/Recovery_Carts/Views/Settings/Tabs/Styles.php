...
<div id="styles" class="nav-content">
    <table class="form-table">
        <tbody>
            <tr>
                <th>
                    <?php esc_html_e( 'Primary color', 'flexify-checkout-for-woocommerce' ); ?>
                ...
                <td>
                    <div class="color-container input-group">
                        ...
                        <button class="btn btn-outline-secondary btn-icon reset-color fcrc-tooltip" data-color="#008aff" data-text="<?php esc_html_e( 'Reset to default color', 'flexify-checkout-for-woocommerce' ) ?>">
