...
<div class="fc-recovery-carts-admin-title-container">
    ...
    <h1 class="fc-recovery-carts-admin-section-tile mb-0"><?php echo esc_html( 'Flexify Checkout - Recuperação de carrinhos abandonados.', 'flexify-checkout-for-woocommerce' ) ?></h1>
</div>
