...
<div class="fc-recovery-carts-admin-title-container">
    ...
    <h1 class="fc-recovery-carts-admin-section-tile mb-0"><?php echo esc_html__( 'Flexify Checkout - Abandoned cart recovery.', 'flexify-checkout-for-woocommerce' ) ?></h1>
</div>

<div class="fc-recovery-carts-admin-title-description">
    <p><?php esc_html_e( 'Recover abandoned carts and orders with cadenced follow-ups. If you need help setting it up, visit our', 'flexify-checkout-for-woocommerce' ) ?>
        <a class="fancy-link" href="<?php esc_attr_e( FC_RECOVERY_CARTS_DOCS_URL ) ?>" target="_blank"><?php esc_html_e( 'Help Center', 'flexify-checkout-for-woocommerce' ) ?></a>
    </p>
</div>
...
<div class="fc-recovery-carts-wrapper">
    <div class="alert alert-info d-flex align-items-center w-fit fs-6">
        ...
        <?php esc_html_e( 'Activate the Pro version of Flexify Checkout to unlock this plugin\'s settings', 'flexify-checkout-for-woocommerce' ); ?>
    </div>
</div>