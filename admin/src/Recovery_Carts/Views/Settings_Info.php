...
<div class="fc-recovery-carts-admin-title-container">
    ...
    <h1 class="fc-recovery-carts-admin-section-tile mb-0"><?php echo esc_html__( 'Flexify Checkout - Recuperação de carrinhos abandonados.', 'flexify-checkout-for-woocommerce' ) ?></h1>
</div>

<div class="fc-recovery-carts-admin-title-description">
    <p><?php esc_html_e( 'Recupere carrinhos e pedidos abandonados com follow up cadenciado. Se precisar de ajuda para configurar, acesse nossa', 'flexify-checkout-for-woocommerce' ) ?>
        <a class="fancy-link" href="<?php esc_attr_e( FC_RECOVERY_CARTS_DOCS_URL ) ?>" target="_blank"><?php esc_html_e( 'Central de ajuda', 'flexify-checkout-for-woocommerce' ) ?></a>
    </p>
</div>
...
<div class="fc-recovery-carts-wrapper">
    <div class="alert alert-info d-flex align-items-center w-fit fs-6">
        ...
        <?php esc_html_e( 'Ative a versão Pro do Flexify Checkout para liberar as configurações deste plugin', 'flexify-checkout-for-woocommerce' ); ?>
    </div>
</div>