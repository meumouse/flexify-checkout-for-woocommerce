...
class Settings_Panel {
    ...
    public function register_admin_menu() {
        ...
        add_menu_page(
            esc_html__( 'Flexify Checkout for WooCommerce', 'flexify-checkout-for-woocommerce' ), // page title
        ...
        add_submenu_page(
            ...
            esc_html__( 'Settings', 'flexify-checkout-for-woocommerce' ), // page title
            esc_html__( 'Settings', 'flexify-checkout-for-woocommerce' ), // submenu title
            'manage_woocommerce', // capability
        ...
        add_submenu_page(
            'flexify-checkout-for-woocommerce', // parent slug
            esc_html__( 'Apps', 'flexify-checkout-for-woocommerce' ), // page title
            esc_html__( 'Apps', 'flexify-checkout-for-woocommerce' ), // submenu title
            'manage_woocommerce', // capability
        ...
        add_submenu_page(
            'flexify-checkout-for-woocommerce', // parent slug
            esc_html__( 'License', 'flexify-checkout-for-woocommerce' ), // page title
            esc_html__( 'License', 'flexify-checkout-for-woocommerce' ), // submenu title
            'manage_woocommerce', // capability
    ...
    public static function get_registered_themes() {
        return apply_filters( 'Flexify_Checkout/Register_Themes', array(
            ...
            'dark' => array(
                'id'        => 'dark',
                'label'     => esc_html__( 'Modern dark', 'flexify-checkout-for-woocommerce' ),
            ...
            'single' => array(
                'id'        => 'single',
                'label'     => esc_html__( 'Single page', 'flexify-checkout-for-woocommerce' ),
                'icon'      => '',
                'status'    => 'soon',
                'classes'   => '',
            ),
