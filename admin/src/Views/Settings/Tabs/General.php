...
<div id="general" class="nav-content">
    <table class="form-table">
        ...
        <tr>
            <th>
                <?php esc_html_e( 'Ativar API para criação de links de checkout direto', 'flexify-checkout-for-woocommerce' ); 
                ...
                <?php endif; ?>
                <span class="flexify-checkout-description"><?php esc_html_e( 'Ative esta opção para habilitar um endpoint para criação de links de checkout direto via API.', 'flexify-checkout-for-woocommerce' ) ?></span>
            </th>
            <td>
                <div class="form-check form-switch <?php echo ( ! License::is_valid() ) ? 'require-pro' : ''; ?>">
                    <input type="checkbox" class="toggle-switch <?php echo ( ! License::is_valid() ) ? 'pro-version' : ''; ?>" id="direct_checkout_api" name="direct_checkout_api" value="yes" <?php checked( Admin_Options::get_setting('direct_checkout_api') === 'yes' && License::is_valid() ); ?> />
                </div>
            </td>
        </tr>
