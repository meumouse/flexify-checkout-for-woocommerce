...
// Re-sync a gateway's checkout-form configuration after its payment component
// mounts. The Swift checkout exposes a persistent form[name=checkout] (see
// CheckoutShell in App.jsx), so Mercado Pago's handler already finds the checkout
// form at page load; re-running its setup once our card fields exist keeps the
// gateway bound to the current form. Guarded so it is a harmless no-op for
// gateways without this handler.
