jQuery(document).ready( function($) {
    ...
    $('.install-module').on('click', function(e) {
        ...
        $.ajax({
            type: 'POST',
            url: fd_modules_params.ajax_url,
            data: {
            ...
            success: function(response) {
                if (response.status === 'success') {
                    ...
                    $('.flexify-dashboard-wrapper').before(`<div class="toast toast-success show">
                    ...
                    $('.flexify-dashboard-wrapper').before(`<div class="toast toast-module-error toast-danger show">
