                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <th class="w-50">
                                            ...
                                            <span class="flexify-checkout-description"><?php esc_html_e( 'Informe a cor de fundo da barra de contagem regressiva. Ou deixe vazio, para que seja usado a cor primária.' ) ?></span>
                                        </th>

                                        <td class="w-50">
                                            <select class="form-select" id="countdown_background_type" name="countdown_background_type">
                                                <option value="primary" <?php selected( Admin_Options::get_setting('countdown_background_type'), 'primary' ); ?>><?php esc_html_e( 'Usar cor primária', 'flexify-checkout-for-woocommerce' ) ?></option>
