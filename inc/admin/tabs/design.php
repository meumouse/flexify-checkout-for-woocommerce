...
<div id="design" class="nav-content">
   <table class="form-table">
         ...
         <td>
            <div class="card card-theme-item active">
               ...
               <div class="card-body">
                  ...
                  <input type="hidden" name="flexify_checkout_theme_modern" value="<?php echo Init::get_setting('flexify_checkout_theme_modern') ?>"/>
               </div>
            </div>
         </td>
         <td>
      ...
      <tr class="header-styles-option-logo">
         ...
         <td>
            <div class="input-group">
               ...
               <button id="flexify-checkout-search-header-logo" class="input-group-button btn btn-outline-secondary"><?php echo esc_html__( 'Procurar', 'flexify-checkout-for-woocommerce' ) ?></button>
            </div>
         </td>
      </tr>
      <tr class="header-styles-option-logo">
         ...
         <td>
            <div class="input-group">
               ...
               <select id="unit_header_width_image_checkout" class="form-select" name="unit_header_width_image_checkout">
                  <option value="px" <?php echo ( Init::get_setting('unit_header_width_image_checkout') == 'px' ) ? "selected=selected" : ""; ?>><?php echo esc_html__( 'px', 'flexify-checkout-for-woocommerce' ) ?></option>
                  <option value="em" <?php echo ( Init::get_setting('unit_header_width_image_checkout') == 'em' ) ? "selected=selected" : ""; ?>><?php echo esc_html__( 'em', 'flexify-checkout-for-woocommerce' ) ?></option>
                  <option value="rem" <?php echo ( Init::get_setting('unit_header_width_image_checkout') == 'rem' ) ? "selected=selected" : ""; ?>><?php echo esc_html__( 'rem', 'flexify-checkout-for-woocommerce' ) ?></option>
               </select>
            </div>
         </td>
      </tr>
      <tr class="header-styles-option-text">
         ...
         <td>
            <input type="text" name="text_brand_checkout_header" class="form-control" placeholder="<?php echo esc_html__( 'CHECKOUT', 'flexify-checkout-for-woocommerce' ) ?>" value="<?php echo Init::get_setting('text_brand_checkout_header') ?>"/>
         </td>
      </tr>
      ...
      <tr>
         ...
         <td>
            <input type="text" name="shortcode_footer" class="form-control input-control-wd-20" placeholder="<?php echo esc_html__( '[shortcode id="101"]', 'flexify-checkout-for-woocommerce' ) ?>" value="<?php echo esc_attr( Init::get_setting('shortcode_footer') ) ?>"/>
         </td>
      </tr>
      ...
      <tr>
         ...
         <td>
            <div class="color-container input-group">
               ...
               <button class="btn btn-outline-secondary btn-icon reset-color fcw-tooltip" data-color="#141D26" data-text="<?php echo esc_html__( 'Redefinir para cor padrão', 'flexify-checkout-for-woocommerce' ) ?>">
      ...
      <tr>
         ...
         <td>
            <div class="color-container input-group">
               ...
               <button class="btn btn-outline-secondary btn-icon reset-color fcw-tooltip" data-color="#33404d" data-text="<?php echo esc_html__( 'Redefinir para cor padrão', 'flexify-checkout-for-woocommerce' ) ?>">
                  <svg class="icon-button" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M12 16c1.671 0 3-1.331 3-3s-1.329-3-3-3-3 1.331-3 3 1.329 3 3 3z"></path><path d="M20.817 11.186a8.94 8.94 0 0 0-1.355-3.219 9.053 9.053 0 0 0-2.43-2.43 8.95 8.95 0 0 0-3.219-1.355 9.028 9.028 0 0 0-1.838-.18V2L8 5l3.975 3V6.002c.484-.002.968.044 1.435.14a6.961 6.961 0 0 1 2.502 1.053 7.005 7.005 0 0 1 1.892 1.892A6.967 6.967 0 0 1 19 13a7.032 7.032 0 0 1-.55 2.725 7.11 7.11 0 0 1-.644 1.188 7.2 7.2 0 0 1-.858 1.039 7.028 7.028 0 0 1-3.536 1.907 7.13 7.13 0 0 1-2.822 0 6.961 6.961 0 0 1-2.503-1.054 7.002 7.002 0 0 1-1.89-1.89A6.996 6.996 0 0 1 5 13H3a9.02 9.02 0 0 0 1.539 5.034 9.096 9.096 0 0 0 2.428 2.428A8.95 8.95 0 0 0 12 22a9.09 9.09 0 0 0 1.814-.183 9.014 9.014 0 0 0 3.218-1.355 8.886 8.886 0 0 0 1.331-1.099 9.228 9.228 0 0 0 1.1-1.332A8.952 8.952 0 0 0 21 13a9.09 9.09 0 0 0-.183-1.814z"></path></svg>
               </button>
            </div>
         </td>
         ...
         <td>
            <div class="input-group">
               ...
               <select id="unit_input_border_radius" class="form-select" name="unit_input_border_radius">
                  <option value="px" <?php echo ( Init::get_setting('unit_input_border_radius') == 'px' ) ? "selected=selected" : ""; ?>><?php echo esc_html__( 'px', 'flexify-checkout-for-woocommerce' ) ?></option>
                  <option value="em" <?php echo ( Init::get_setting('unit_input_border_radius') == 'em' ) ? "selected=selected" : ""; ?>><?php echo esc_html__( 'em', 'flexify-checkout-for-woocommerce' ) ?></option>
                  <option value="rem" <?php echo ( Init::get_setting('unit_input_border_radius') == 'rem' ) ? "selected=selected" : ""; ?>><?php echo esc_html__( 'rem', 'flexify-checkout-for-woocommerce' ) ?></option>
               </select>
            </div>
         </td>
      </tr>
      ...
      <tr>
         ...
         <td>
            <div class="input-group">
               ...
               <button id="set_new_font_family_trigger" class="btn btn-outline-secondary input-group-button ms-2"><?php echo esc_html__( 'Adicionar nova fonte', 'flexify-checkout-for-woocommerce' ) ?></button>
            </div>
         </td>
      </tr>
         ...
         <td>
            <div class="input-group">
               ...
               <select id="h2_size_unit" class="form-select" name="h2_size_unit">
                  <option value="px" <?php echo ( Init::get_setting( 'h2_size_unit' ) == 'px' ) ? "selected=selected" : ""; ?>><?php echo esc_html__( 'px', 'flexify-checkout-for-woocommerce' ) ?></option>
                  <option value="em" <?php echo ( Init::get_setting( 'h2_size_unit' ) == 'em' ) ? "selected=selected" : ""; ?>><?php echo esc_html__( 'em', 'flexify-checkout-for-woocommerce' ) ?></option>
                  <option value="rem" <?php echo ( Init::get_setting( 'h2_size_unit' ) == 'rem' ) ? "selected=selected" : ""; ?>><?php echo esc_html__( 'rem', 'flexify-checkout-for-woocommerce' ) ?></option>
               </select>
            </div>
         </td>
      </tr>
