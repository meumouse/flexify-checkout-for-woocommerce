...
<div id="design" class="nav-content">
   <table class="form-table">
      ...
      <tr>
         ...
         <td>
            <select id="checkout_header_type" name="checkout_header_type" class="form-select">
               <option value="logo" <?php echo ( Init::get_setting('checkout_header_type') === 'logo' ) ? "selected=selected" : ""; ?>><?php esc_html_e( 'Imagem (Padrão)', 'flexify-checkout-for-woocommerce' ) ?></option>
               <option value="text" <?php echo ( Init::get_setting('checkout_header_type') === 'text' ) ? "selected=selected" : ""; ?>><?php esc_html_e( 'Texto', 'flexify-checkout-for-woocommerce' ) ?></option>
            </select>
         </td>
      </tr>
         ...
         <td>
            <div class="input-group">
               ...
               <select id="unit_header_width_image_checkout" class="form-select" name="unit_header_width_image_checkout">
                  <option value="px" <?php echo ( Init::get_setting('unit_header_width_image_checkout') == 'px' ) ? "selected=selected" : ""; ?>><?php esc_html_e( 'px', 'flexify-checkout-for-woocommerce' ) ?></option>
                  <option value="em" <?php echo ( Init::get_setting('unit_header_width_image_checkout') == 'em' ) ? "selected=selected" : ""; ?>><?php esc_html_e( 'em', 'flexify-checkout-for-woocommerce' ) ?></option>
                  <option value="rem" <?php echo ( Init::get_setting('unit_header_width_image_checkout') == 'rem' ) ? "selected=selected" : ""; ?>><?php esc_html_e( 'rem', 'flexify-checkout-for-woocommerce' ) ?></option>
               </select>
            </div>
         </td>
      </tr>
      ...
      <tr class="header-styles-option-text">
         ...
         <td>
            <input type="text" name="text_brand_checkout_header" class="form-control" placeholder="<?php esc_html_e( 'CHECKOUT', 'flexify-checkout-for-woocommerce' ) ?>" value="<?php echo Init::get_setting('text_brand_checkout_header') ?>"/>
         </td>
      </tr>
      ...
      <tr>
         ...
         <td>
            <input type="text" name="shortcode_header" class="form-control input-control-wd-20" placeholder="<?php esc_html_e( '[shortcode id="100"]', 'flexify-checkout-for-woocommerce' ) ?>" value="<?php echo esc_attr( Init::get_setting('shortcode_header') ) ?>"/>
         </td>
      </tr>
      ...
      <tr>
         ...
         <td>
            <input type="text" name="shortcode_footer" class="form-control input-control-wd-20" placeholder="<?php esc_html_e( '[shortcode id="101"]', 'flexify-checkout-for-woocommerce' ) ?>" value="<?php echo esc_attr( Init::get_setting('shortcode_footer') ) ?>"/>
         </td>
      </tr>
         ...
         <td>
            <div class="input-group">
               ...
               <select id="unit_input_border_radius" class="form-select" name="unit_input_border_radius">
                  <option value="px" <?php echo ( Init::get_setting('unit_input_border_radius') == 'px' ) ? "selected=selected" : ""; ?>><?php esc_html_e( 'px', 'flexify-checkout-for-woocommerce' ) ?></option>
                  <option value="em" <?php echo ( Init::get_setting('unit_input_border_radius') == 'em' ) ? "selected=selected" : ""; ?>><?php esc_html_e( 'em', 'flexify-checkout-for-woocommerce' ) ?></option>
                  <option value="rem" <?php echo ( Init::get_setting('unit_input_border_radius') == 'rem' ) ? "selected=selected" : ""; ?>><?php esc_html_e( 'rem', 'flexify-checkout-for-woocommerce' ) ?></option>
               </select>
            </div>
         </td>
      </tr>
         ...
         <td>
            <div class="input-group">
               ...
               <select id="h2_size_unit" class="form-select" name="h2_size_unit">
                  <option value="px" <?php echo ( Init::get_setting( 'h2_size_unit' ) == 'px' ) ? "selected=selected" : ""; ?>><?php esc_html_e( 'px', 'flexify-checkout-for-woocommerce' ) ?></option>
                  <option value="em" <?php echo ( Init::get_setting( 'h2_size_unit' ) == 'em' ) ? "selected=selected" : ""; ?>><?php esc_html_e( 'em', 'flexify-checkout-for-woocommerce' ) ?></option>
                  <option value="rem" <?php echo ( Init::get_setting( 'h2_size_unit' ) == 'rem' ) ? "selected=selected" : ""; ?>><?php esc_html_e( 'rem', 'flexify-checkout-for-woocommerce' ) ?></option>
               </select>
            </div>
         </td>
      </tr>
