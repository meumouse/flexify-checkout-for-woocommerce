    ...
    <table class="form-table">
        ...
        <tr>
            <th>
                ...
                <span class="flexify-checkout-description"><?php echo esc_html__( 'Ative esta opção para adicionar máscaras de preenchimento em campos da finalização de compras.', 'flexify-checkout-for-woocommerce' ) ?></span>
            </th>
            <td>
                <div class="form-check form-switch">
        ...
        <tr class="w-100">
            <th>
                <?php echo esc_html__( 'Gerenciar os campos e etapas da finalização de compras', 'flexify-checkout-for-woocommerce' ); ?>
            ...
            <td class="step-container">
                ...
                <div id="contact_step" data-step="1">
                    <?php foreach ( $fields as $index => $value ) :
                        ...
                        $current_field_step_input_mask = isset( $fields[$index]['input_mask'] ) ? $fields[$index]['input_mask'] : '';
                                    ...
                                    <div class="popup-body">
                                        <table class="form-table">
                                            ...
                                            <tr class="require-input-mask">
                                                ...
                                                <td class="w-50">
                                                    <input type="text" class="form-control" name="checkout_step[<?php echo $index; ?>][input_mask]" value="<?php echo $current_field_step_input_mask ?>"/>
                                                </td>
                                            </tr>
