   ...
   <div class="cards-group ps-5 mb-5">
      <div class="card text-center p-0 m-4">
         ...
         <div class="card-body px-3 py-4 d-flex flex-column align-items-center text-center">
            <h5 class="card-title pt-0 border-top-0"><?php echo esc_html__( 'Flexify Checkout - Inter addon', 'flexify-checkout-for-woocommerce' ) ?></h5>
            ...
            <p class="card-text fs-sm mb-4"><?php echo esc_html__( 'Comece a receber via Pix e Boleto com aprovação imediata e sem cobrança de taxas. Exclusivo para clientes Inter Empresas.', 'flexify-checkout-for-woocommerce' ) ?></p>
            
            <?php if ( is_plugin_active('module-inter-bank-for-flexify-checkout/module-inter-bank-for-flexify-checkout.php') ) : ?>
               <button id="require_inter_bank_module_trigger" class="btn btn-sm btn-outline-primary <?php echo ( ! License::is_valid() ) ? 'pro-version' : ''; ?>"><?php echo esc_html__( 'Configurar', 'flexify-checkout-for-woocommerce' ) ?></button>
            <?php elseif ( array_key_exists( 'module-inter-bank-for-flexify-checkout/module-inter-bank-for-flexify-checkout.php', get_plugins() ) ) : ?>
               <button class="btn btn-sm btn-primary activate-plugin <?php echo ( ! License::is_valid() ) ? 'pro-version' : ''; ?>" data-plugin-slug="<?php echo esc_attr('module-inter-bank-for-flexify-checkout/module-inter-bank-for-flexify-checkout.php'); ?>"><?php echo esc_html__( 'Ativar módulo', 'flexify-checkout-for-woocommerce' ) ?></button>
            <?php else : ?>
               <button class="btn btn-sm btn-primary install-module <?php echo ( ! License::is_valid() ) ? 'pro-version' : ''; ?>" data-plugin-url="https://github.com/meumouse/module-inter-bank-for-flexify-checkout/raw/main/dist/module-inter-bank-for-flexify-checkout.zip" data-plugin-slug="<?php echo esc_attr('module-inter-bank-for-flexify-checkout/module-inter-bank-for-flexify-checkout.php'); ?>"><?php echo esc_html__( 'Instalar módulo', 'flexify-checkout-for-woocommerce' ) ?></button>
            <?php endif; ?>
         </div>
      ...
      <div class="card text-center p-0 m-4">
         ...
         <div class="card-body px-3 py-4 d-flex flex-column align-items-center text-center">
               <h5 class="card-title pt-0 border-top-0"><?php echo esc_html__( 'Joinotify', 'flexify-checkout-for-woocommerce' ) ?></h5>
               <p class="card-text fs-sm mb-4"><?php echo esc_html__( 'Automatize o envio de mensagens via WhatsApp ao receber eventos no Flexify Checkout, recupere vendas de maneira mais assertiva. Deixe tudo no fluxo certo sem esforço!', 'flexify-checkout-for-woocommerce' ) ?></p>

               <div class="badge bg-translucent-primary rounded-pill py-2 px-3 fs-md"><?php echo esc_html__( 'Em breve', 'flexify-checkout-for-woocommerce' ) ?></div>
         </div>
      ...
      <div class="card text-center p-0 m-4">
         ...
         <div class="card-body px-3 py-4 d-flex flex-column align-items-center text-center">
               <h5 class="card-title pt-0 border-top-0"><?php echo esc_html__( 'Google Maps', 'flexify-checkout-for-woocommerce' ) ?></h5>
               <p class="card-text fs-sm mb-4"><?php echo esc_html__( 'Facilite o preenchimento do endereço de entrega aos usuários, permitindo pesquisar seu endereço ou usando recursos de geolocalização com Google Maps.', 'flexify-checkout-for-woocommerce' ) ?></p>
