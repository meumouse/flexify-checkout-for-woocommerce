   ...
   <table class="form-table">
      ...
      */
      ...
      <tr>
         ...
         <td>
            <div class="form-check form-switch">
               <input type="checkbox" class="toggle-switch" id="enable_remove_quantity_select" name="enable_remove_quantity_select" value="yes" <?php checked( Init::get_setting('enable_remove_quantity_select') === 'yes' ); ?> />
            </div>
         </td>
      </tr>
      ...
      <tr>
         ...
         <td>
            <div class="form-check form-switch <?php echo ( ! License::is_valid() ) ? 'require-pro' : ''; ?>">
               <input type="checkbox" class="toggle-switch <?php echo ( ! License::is_valid() ) ? 'pro-version' : ''; ?>" id="enable_shipping_to_different_address" name="enable_shipping_to_different_address" value="yes" <?php checked( Init::get_setting('enable_shipping_to_different_address') === 'yes' && License::is_valid() ); ?> />
            </div>
         </td>
      </tr>
      ...
      <tr class="show-coupon-code-enabled">
         ...
         <td>
            <input type="text" name="coupon_code_for_auto_apply" class="form-control" placeholder="<?php esc_html_e( 'CUPOMDEDESCONTO', 'flexify-checkout-for-woocommerce' ) ?>" value="<?php echo Init::get_setting( 'coupon_code_for_auto_apply' ) ?>"/>
         </td>
      </tr>
      ...
      <tr>
         ...
         <td>
            <div class="form-check form-switch <?php echo ( ! License::is_valid() ) ? 'require-pro' : ''; ?>">
               <input type="checkbox" class="toggle-switch <?php echo ( ! License::is_valid() ) ? 'pro-version' : ''; ?>" id="enable_animation_process_purchase" name="enable_animation_process_purchase" value="yes" <?php checked( Init::get_setting('enable_animation_process_purchase') === 'yes' && License::is_valid() ); ?> />
            </div>
         </td>
                     ...
                     <table class="popup-table">
                        <tbody>
                           <tr>
                              ...
                              <td>
                                 <input type="text" name="text_animation_process_purchase_1" class="form-control input-control-wd-20" value="<?php echo esc_attr( Init::get_setting('text_animation_process_purchase_1') ) ?>"/>
                              </td>
                           </tr>
                           ...
                           <tr>
                              ...
                              <td>
                                 <div class="input-group">
                                    <input type="text" name="animation_process_purchase_file_1" class="form-control" value="<?php echo Init::get_setting('animation_process_purchase_file_1') ?>"/>
                           ...
                           <tr>
                              ...
                              <td>
                                 <input type="text" name="text_animation_process_purchase_2" class="form-control input-control-wd-20" value="<?php echo esc_attr( Init::get_setting('text_animation_process_purchase_2') ) ?>"/>
                              </td>
                           </tr>
                           ...
                           <tr>
                              ...
                              <td>
                                 <div class="input-group">
                                    <input type="text" name="animation_process_purchase_file_2" class="form-control" value="<?php echo Init::get_setting('animation_process_purchase_file_2') ?>"/>
                           ...
                           <tr>
                              ...
                              <td>
                                 <input type="text" name="text_animation_process_purchase_3" class="form-control input-control-wd-20" value="<?php echo esc_attr( Init::get_setting('text_animation_process_purchase_3') ) ?>"/>
                              </td>
                           </tr>
                           ...
                           <tr>
                              ...
                              <td>
                                 <div class="input-group">
                                    <input type="text" name="animation_process_purchase_file_3" class="form-control" value="<?php echo Init::get_setting('animation_process_purchase_file_3') ?>"/>
