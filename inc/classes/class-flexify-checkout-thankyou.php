...
class Flexify_Checkout_Thankyou {
		...
		<div class="flexify-review-customer flexify-review-customer--ty">
			...
			<div class="flexify-review-customer__row">
				...
				<div class='flexify-review-customer__content'>
					<p>
					<?php
						echo __( $order->get_payment_method_title() );
					?>
					</p>
				</div>
			</div>
	...
	public static function contact_us( $order ) {
		$contact_page = Flexify_Checkout_Init::get_setting('contact_page_thankyou');
		$shop_url = Flexify_Checkout_Helpers::get_shop_page_url(); ?>
