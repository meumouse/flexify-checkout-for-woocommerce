...
<div class="woocommerce-form-login-wrap">
	<div class="woocommerce-form woocommerce-form-login login <?php echo esc_attr( $auto_open_class ); ?>">
		<div class="flexify-login-notice" aria-live="polite" aria-atomic="true"></div>

		<div class="flexify-login-view flexify-login-view--login">
			<form class="flexify-login-form" method="post">
				<?php
				/**
				 * Before login form.
				 *
